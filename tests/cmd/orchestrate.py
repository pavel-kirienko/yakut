...
import time
import pytest
from yakut.cmd.orchestrate import exec_composition, load_composition, Stack, Context
...
def _unittest_execute_composition_a(capsys: pytest.CaptureFixture) -> None:
    ...
    assert 123 == exec_composition(ctx, comp, predicate=lambda: True, stack=Stack())
